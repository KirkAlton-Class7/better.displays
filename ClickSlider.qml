// Adapted from Omarchy shell/Ui/PanelSlider.qml. See licenses/omarchy-license.txt.
// Wheel/touchpad scrolling belongs to the surrounding panel, never brightness.
import QtQuick
import qs.Commons
import qs.Ui
